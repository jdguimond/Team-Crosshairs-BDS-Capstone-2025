...
# Modified for LSC586 to provide input/ output files as command line args -jss
import sys

root_path = sys.argv[1] #'/home/jsinohui/CRISPR-DIPOFF/'
model_dir = root_path + "Trained Models/"
input_dir = root_path + "Sample Input/"
output_dir = root_path + "Sample Output/"

#root_path = '/home/jsinohui/CRISPR-DIPOFF/'
input_filename = sys.argv[2] #"CRISPR-DIPOFF_training_data_circleseq_full_v2.csv"
output_filename = sys.argv[3] #"crispr-dipoff_out.csv"
CHANNEL_SIZE = 4
